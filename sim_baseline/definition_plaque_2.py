...
distance = 5.0 #mm
rayon = 4.0 #mm
plaque_epaisseur =  0.5 #mm

# Fréquence modale maximale
frequ_max_mode = 500.0 #vérifier unité si Hz ou rad/s?
...
session.writeFieldReport(fileName='abaqus.csv', append=OFF, sortItem='Node Label', odb=odb, step=0, frame=29, outputPosition=NODAL, variable=(('U', NODAL, ((COMPONENT, 'U1'), (COMPONENT, 'U2'), (COMPONENT, 'U3'), )), ), stepFrame=ALL)
