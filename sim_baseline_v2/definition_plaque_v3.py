...
mdb.models['Model-1'].HomogeneousShellSection(name='tole', preIntegrate=OFF, 
    material='acier', thicknessType=UNIFORM, thickness=1.0, 
...
# o3 = session.openOdb(
    # name='C:/Users/joel.kuster/switchdrive/Institution/Projets/FEM_PINN/vibration.odb')
# session.viewports['Viewport: 1'].setValues(displayedObject=o3)
# session.viewports['Viewport: 1'].makeCurrent()
# session.viewports['Viewport: 1'].odbDisplay.display.setValues(plotState=(
    # CONTOURS_ON_DEF, ))
# Filed export  
# Ajouter une pause pour attendre que le nouveau fichier odb soit écrit
# odb = session.odbs['C:/temp/vibration_clean.odb']
# import os.path
# import time

# while os.path.isfile('C:/temp/matrix_clean.odb'):
    # print('waiting')
    # time.sleep(5)
    

# odb = session.odbs['C:/temp/matrix_clean.odb']

# o3 = session.openOdb(name='C:/temp/matrix_clean.odb')
# session.viewports['Viewport: 1'].setValues(displayedObject=o3)
# session.viewports['Viewport: 1'].makeCurrent()
...
session.fieldReportOptions.setValues(reportFormat=COMMA_SEPARATED_VALUES, 
    numberFormat=nf)
session.writeFieldReport(fileName='mat_X.csv', append=OFF, 
...
# modifier le fichier .inp généré en en ajoutant 
#
# *STEP
