...
# Répertoire de travail de abaqus ou se trouve le fichiers
direct = 'c:/temp/'
...
def Import_matrix_raw(direct, f_mass, f_stif, f_X): 
    # importation des matrices
    mass_raw = pd.read_csv(direct + f_mass, header = None, names = ['Node_1', 'dof_1','Node_2', 'dof_2', 'mass_t'])
    stif_raw = pd.read_csv(direct +f_stif, header = None, names = ['Node_1', 'dof_1','Node_2', 'dof_2', 'E'])
    X_raw = pd.read_csv(direct +f_X)
